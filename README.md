...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/bold-smoke-e6f0
```

A live public deployment of this template is available at [https://bold-smoke-e6f0.templates.workers.dev](https://bold-smoke-e6f0.templates.workers.dev)
